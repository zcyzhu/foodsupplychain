...
export class ShipmentReceivedComponent implements OnInit {
  ...
  receivedDateTime = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.foodSupplyChain.food.ShipmentReceived',
      'receivedDateTime': this.receivedDateTime.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.receivedDateTime) {
        formObject.receivedDateTime = result.receivedDateTime;
      } else {
        formObject.receivedDateTime = null;
      }
